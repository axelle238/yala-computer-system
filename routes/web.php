...
Route::get('/produk/{id}', \App\Livewire\Store\ProductDetail::class)->name('store.product.detail');
Route::get('/paket/{slug}', \App\Livewire\Store\BundleDetail::class)->name('store.bundle.detail');
Route::get('/bandingkan', \App\Livewire\Store\Comparison::class)->name('store.compare');
Route::get('/komunitas', \App\Livewire\Community\Gallery::class)->name('store.community');
Route::get('/berita', \App\Livewire\Store\News\Index::class)->name('store.news.index');
Route::get('/berita/{slug}', \App\Livewire\Store\News\Show::class)->name('store.news.show');
Route::get('/pusat-bantuan', \App\Livewire\Store\HelpCenter::class)->name('store.help-center');
Route::get('/rakit-pc', \App\Livewire\Store\PcBuilder::class)->name('store.pc-builder');
Route::get('/garansi', \App\Livewire\Store\WarrantyCheck::class)->name('store.warranty-check');
Route::get('/lacak-servis', \App\Livewire\Front\TrackService::class)->name('store.track-service');
Route::get('/lacak-pesanan', \App\Livewire\Front\TrackOrder::class)->name('store.track-order');
...
Route::get('/keinginan', \App\Livewire\Store\Wishlist::class)->name('store.wishlist');
Route::get('/pesanan-berhasil/{id}', \App\Livewire\Store\OrderSuccess::class)->name('store.order.success');
Route::get('/sitemap.xml', [\App\Http\Controllers\SitemapController::class, 'index'])->name('sitemap');

Route::view('/kebijakan-privasi', 'store.privacy-policy')->name('store.privacy-policy');
Route::view('/syarat-ketentuan', 'store.terms-of-service')->name('store.terms');
...
Route::prefix('anggota')->middleware('auth')->group(function () {
    ...
    Route::get('/servis/pesan', \App\Livewire\Service\Booking::class)->name('member.service.booking');
...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::get('/pemasaran/ulasan', \App\Livewire\Pemasaran\Ulasan\Pengelola::class)->name('marketing.reviews.manager');
    ...
    Route::get('/pemasaran/whatsapp', \App\Livewire\Pemasaran\PesanMassalWhatsapp::class)->name('marketing.whatsapp.blast');
    ...
    Route::get('/cetak/label-masal', [\App\Http\Controllers\PrintController::class, 'labels'])->name('print.labels.preview');
    ...
    Route::get('/keuangan/kasir/buka', \App\Livewire\Finance\CashRegisterManager::class)->name('shift.open'); // Alias for middleware requirement
