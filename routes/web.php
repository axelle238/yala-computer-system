...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::get('/pelanggan/kotak-masuk', \App\Livewire\Admin\Inbox::class)->name('admin.pelanggan.kotak-masuk');
    ...
    // Permintaan Stok (Pengadaan)
    Route::get('/permintaan-stok', \App\Livewire\PurchaseRequisitions\Index::class)->name('admin.permintaan-stok.indeks');
    Route::get('/permintaan-stok/buat', \App\Livewire\PurchaseRequisitions\Create::class)->name('admin.permintaan-stok.buat');
    Route::get('/permintaan-stok/{id}', \App\Livewire\PurchaseRequisitions\Show::class)->name('admin.permintaan-stok.tampil');
