    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('articles')) {
            ...
            Schema::table('articles', function (Blueprint $table) {
                if (!Schema::hasColumn('articles', 'category')) $table->string('category')->default('General');
                if (!Schema::hasColumn('articles', 'tags')) $table->json('tags')->nullable();
                if (!Schema::hasColumn('articles', 'author_name')) $table->string('author_name')->nullable();
                if (!Schema::hasColumn('articles', 'is_featured')) $table->boolean('is_featured')->default(false);
                if (!Schema::hasColumn('articles', 'views_count')) $table->unsignedBigInteger('views_count')->default(0);
            });
        }
    }
