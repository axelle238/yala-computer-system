...
<body class="bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 font-['Plus_Jakarta_Sans'] antialiased selection:bg-blue-600 selection:text-white pb-20 md:pb-0 transition-colors duration-300">
    
    <!-- Background Accents -->
    <div class="fixed top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div class="absolute top-0 right-0 w-[800px] h-[600px] bg-blue-100/40 dark:bg-blue-900/20 rounded-full blur-3xl opacity-50"></div>
        <div class="absolute bottom-0 left-0 w-[600px] h-[600px] bg-indigo-100/40 dark:bg-indigo-900/20 rounded-full blur-3xl opacity-50"></div>
    </div>
    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <!-- Desktop Sidebar -->
        <aside class="hidden md:flex flex-col w-72 bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-r border-slate-200 dark:border-slate-700 h-screen sticky top-0 shadow-sm z-20 transition-colors duration-300">
                    ...
                    <p class="text-[10px] text-slate-500 font-medium uppercase tracking-wider">Inventory Intelligence</p>
                        ...
                        <nav class="flex-1 px-4 space-y-1.5 mt-2">
                            ...
                            <a href="{{ route('transactions.index') }}" class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all group {{ request()->routeIs('transactions.*') ? 'bg-blue-50 text-blue-700 font-semibold shadow-sm ring-1 ring-blue-100' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                                               ...
                                               <a href="{{ route('customers.index') }}" class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all group {{ request()->routeIs('customers.*') ? 'bg-blue-50 text-blue-700 font-semibold shadow-sm ring-1 ring-blue-100' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
            
                                                   <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition-colors {{ request()->routeIs('customers.*') ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <a href="{{ route('employees.index') }}" class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all group {{ request()->routeIs('employees.*') ? 'bg-blue-50 text-blue-700 font-semibold shadow-sm ring-1 ring-blue-100' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                                                ...
                                                <a href="{{ route('employees.payroll') }}" class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all group {{ request()->routeIs('employees.payroll') ? 'bg-blue-50 text-blue-700 font-semibold shadow-sm ring-1 ring-blue-100' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
            
            
            
                            
            
                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition-colors {{ request()->routeIs('employees.payroll') ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                    ...
                                                                    <a href="{{ route('expenses.index') }}" class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all group {{ request()->routeIs('expenses.index') ? 'bg-blue-50 text-blue-700 font-semibold shadow-sm ring-1 ring-blue-100' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
            
            
            
                            
            
                                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition-colors {{ request()->routeIs('expenses.index') ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                                        ...
                                                                                        <a href="{{ route('finance.profit-loss') }}" class="flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all group {{ request()->routeIs('finance.profit-loss') ? 'bg-blue-50 text-blue-700 font-semibold shadow-sm ring-1 ring-blue-100' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
            
            
            
                            
            
                                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition-colors {{ request()->routeIs('finance.profit-loss') ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="p-4 border-t border-slate-100 dark:border-slate-700 mt-auto space-y-2">
                <!-- Dark Mode Toggle -->
                <button @click="toggle()" class="w-full flex items-center justify-between p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-sm font-medium text-slate-600 dark:text-slate-300">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-600 flex items-center justify-center">
                            <svg x-show="!darkMode" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
                            <svg x-show="darkMode" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display: none;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" /></svg>
                        </div>
                        <span x-text="darkMode ? 'Light Mode' : 'Dark Mode'"></span>
                    </div>
                    <div class="relative w-8 h-4 bg-slate-200 dark:bg-slate-600 rounded-full transition-colors">
                        <div class="absolute top-0.5 left-0.5 w-3 h-3 bg-white rounded-full transition-transform" :class="darkMode ? 'translate-x-4' : 'translate-x-0'"></div>
                    </div>
                </button>

                <form method="POST" action="{{ route('logout') }}" class="flex items-center gap-3 p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 cursor-pointer transition-colors w-full" onclick="this.closest('form').submit()">
                    @csrf
