            ...
            <div class="flex justify-between items-center h-16">
                ...
                <a href="/" wire:navigate class="flex items-center gap-3 group">
                    ...
                    <div class="flex flex-col">
                        <span class="font-tech font-bold text-xl text-slate-900 tracking-tight leading-none uppercase">{{ \App\Models\Setting::get('store_name', 'YALA COMPUTER') }}</span>
                        <span class="text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em] leading-none mt-0.5">{{ \App\Models\Setting::get('hero_title', 'Future Tech Store') }}</span>
                    </div>
                </a>
