<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-6 animate-fade-in-up">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <a href="{{ route('news.create') }}" class="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-xl shadow-lg shadow-purple-600/30 hover:-translate-y-0.5 transition-all flex items-center gap-2">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
        <div class="p-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
            <input wire:model.live.debounce.300ms="search" type="text" class="w-full md:w-96 pl-10 pr-4 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-purple-500 text-sm" placeholder="Cari Judul Artikel...">
        </div>
                    ...
                    @forelse($articles as $article)
                        <tr class="hover:bg-purple-50/30 dark:hover:bg-purple-900/10 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center flex justify-center gap-2">
                                <a href="{{ route('news.edit', $article->id) }}" class="text-blue-500 hover:text-blue-700 p-1">
