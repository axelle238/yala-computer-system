<div class="h-[calc(100vh-100px)] flex flex-col">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6 px-4 pt-4">
        ...
        <div class="relative w-full md:w-96">
            <input wire:model.live.debounce.300ms="search" type="text" class="w-full pl-10 pr-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm focus:ring-blue-500 text-sm" placeholder="Cari No. Order atau Pelanggan...">
