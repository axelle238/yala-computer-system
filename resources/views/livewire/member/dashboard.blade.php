            ...
            <div class="lg:col-span-2 space-y-8 animate-fade-in-up delay-100">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-sm">
                        ...
                        <div class="space-y-4">
                            @foreach($activeServices as $ticket)
                                <a href="{{ route('track-service', ['ticket' => $ticket->ticket_number]) }}" class="block bg-cyan-50 dark:bg-cyan-900/10 rounded-xl p-4 border border-cyan-100 dark:border-cyan-800 hover:border-cyan-300 transition-colors group">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-sm">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('pc-builder') }}" class="text-xs font-bold text-purple-600 hover:underline">+ Rakit Baru</a>
                    </div>
