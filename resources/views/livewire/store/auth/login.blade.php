<div>
    ...
    <form wire:submit="login" class="space-y-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('customer.forgot-password') }}" class="text-xs text-cyan-500 hover:text-cyan-400">Lupa Kata Sandi?</a>
        </div>
    ...
    <div class="mt-6 text-center text-sm text-slate-500">
        Belum punya akun? <a href="{{ route('customer.register') }}" class="text-cyan-500 hover:text-cyan-400 font-bold">Daftar disini</a>
    </div>
</div>
