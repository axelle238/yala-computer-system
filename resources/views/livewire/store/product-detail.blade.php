        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex gap-4 mt-8 pt-8 border-t border-white/10 sticky bottom-0 bg-slate-950/80 backdrop-blur-md p-4 -mx-4 lg:static lg:bg-transparent lg:p-0">
                    <button wire:click="addToCart" class="flex-1 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 flex items-center justify-center gap-3 group {{ $product->stock_quantity < 1 ? 'opacity-50 cursor-not-allowed grayscale' : '' }}" {{ $product->stock_quantity < 1 ? 'disabled' : '' }}>
