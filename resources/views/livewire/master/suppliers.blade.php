<div class="space-y-6 animate-fade-in-up">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <a href="{{ route('master.suppliers.create') }}" class="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-lg hover:-translate-y-0.5 transition-all flex items-center gap-2">
                    ...
                    @forelse($suppliers as $sup)
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right flex justify-end gap-2">
                                <a href="{{ route('master.suppliers.edit', $sup->id) }}" class="text-emerald-600 hover:text-emerald-800 font-bold">Edit</a>
