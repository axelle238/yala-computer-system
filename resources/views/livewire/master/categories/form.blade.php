<div class="max-w-4xl mx-auto space-y-8 animate-fade-in-up">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.master.kategori') }}" class="group flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-600 dark:text-slate-300 font-bold hover:border-blue-500 hover:text-blue-500 transition-all shadow-sm">
