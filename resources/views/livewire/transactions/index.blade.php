<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.transaksi.buat') }}" class="flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-lg shadow-blue-600/20 hover:shadow-blue-600/40 transition-all font-semibold text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($transactions as $trx)
                        <tr class="hover:bg-blue-50/30 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('admin.cetak.transaksi', $trx->id) }}" target="_blank" class="text-slate-400 hover:text-blue-600 transition-colors" title="Cetak Struk">
