<aside 
    ...
    x-data="{ 
        grupAktif: '{{ 
            ...
            (request()->routeIs('sales.*', 'orders.*', 'quotations.*') ? 'penjualan' : 
            (request()->routeIs('services.*', 'rma.*', 'assembly.*', 'knowledge.*') ? 'servis' : 
            (request()->routeIs('products.*', 'warehouses.*', 'purchase-orders.*', 'procurement.*', 'logistics.*', 'purchase-requisitions.*') ? 'inventaris' : 
