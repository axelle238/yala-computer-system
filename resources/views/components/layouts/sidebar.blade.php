<aside 
    ...
    x-data="{ 
        grupAktif: '{{ 
            ...
            (request()->routeIs('admin.transaksi.*', 'admin.pesanan.*', 'admin.penawaran.*') ? 'penjualan' : 
            (request()->routeIs('admin.servis.*', 'admin.garansi.*', 'admin.perakitan.*', 'admin.pengetahuan.*') ? 'servis' : 
            (request()->routeIs('admin.produk.*', 'admin.gudang.*', 'admin.pesanan-pembelian.*', 'admin.procurement.*', 'admin.logistik.*', 'admin.permintaan-pembelian.*') ? 'inventaris' : 
            (request()->routeIs('admin.keuangan.*', 'admin.analitik.*', 'admin.pengeluaran.*') ? 'keuangan' : 
            (request()->routeIs('admin.pelanggan.*', 'admin.pemasaran.*') ? 'crm' : 
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1 custom-scrollbar">
        ...
        <div>
            <button @click="toggleGrup('inventaris')" 
                    class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-200 group {{ request()->routeIs('admin.produk.*', 'admin.gudang.*', 'admin.pesanan-pembelian.*', 'admin.procurement.*', 'admin.logistik.*', 'admin.permintaan-pembelian.*') ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-slate-800/50' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                <div class="flex items-center gap-3">
            ...
            <div x-show="grupAktif === 'inventaris'" x-collapse class="space-y-1 pl-11 pr-2 mt-1">
                ...
                <a href="{{ route('admin.permintaan-pembelian.indeks') }}" class="block py-2 px-3 rounded-md text-sm transition-colors {{ request()->routeIs('admin.permintaan-pembelian.indeks') ? 'text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700' : 'text-slate-500 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                    Permintaan Stok
                </a>
        ...
        <div>
            <button @click="toggleGrup('media')" 
                    class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-200 group {{ request()->routeIs('admin.berita.*', 'admin.spanduk.*', 'admin.pelanggan.inbox') ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-slate-800/50' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5 {{ request()->routeIs('admin.berita.*', 'admin.spanduk.*', 'admin.pelanggan.inbox') ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-400 group-hover:text-indigo-500' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" /></svg>
                    <span>Media & Customer Service</span>
                </div>
            ...
            <div x-show="grupAktif === 'media'" x-collapse class="space-y-1 pl-11 pr-2 mt-1">
                ...
                <a href="{{ route('admin.pelanggan.inbox') }}" class="block py-2 px-3 rounded-md text-sm transition-colors {{ request()->routeIs('admin.pelanggan.inbox') ? 'text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700' : 'text-slate-500 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                    Pesan Email Masuk
                </a>
        ...
        <div>
            <button @click="toggleGrup('crm')" 
                    class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-200 group {{ request()->routeIs('admin.pelanggan.*', 'admin.pemasaran.*') ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-slate-800/50' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5 {{ request()->routeIs('admin.pelanggan.*', 'admin.pemasaran.*') ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-400 group-hover:text-indigo-500' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
                    <span>CRM & Pelanggan</span>
                </div>
                <svg class="w-4 h-4 transition-transform duration-200" :class="grupAktif === 'crm' ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
            </button>
            <div x-show="grupAktif === 'crm'" x-collapse class="space-y-1 pl-11 pr-2 mt-1">
                ...
                <a href="{{ route('admin.pemasaran.obral-kilat.indeks') }}" class="block py-2 px-3 rounded-md text-sm transition-colors {{ request()->routeIs('admin.pemasaran.obral-kilat.indeks') ? 'text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700' : 'text-slate-500 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                    Flash Sale
                </a>
                <a href="{{ route('admin.pemasaran.ulasan') }}" class="block py-2 px-3 rounded-md text-sm transition-colors {{ request()->routeIs('admin.pemasaran.ulasan') ? 'text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700' : 'text-slate-500 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800' }}">
                    Ulasan & Rating
                </a>
